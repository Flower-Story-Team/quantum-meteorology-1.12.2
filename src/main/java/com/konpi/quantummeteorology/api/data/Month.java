...
public enum Month {
	...
	JANUARY(Season.WINTER, -5, 0xCCCC99, 1, 0, 0, 0xCCCC99), // 1
	FEBRUARY(Season.WINTER, -2, 0x669966, 1, 0, 0, 0x669966), // 2
	MARCH(Season.SPRING, 5, 0x66CC33, 3, 0x66CC66, 1, 0x66CC33), // 3
	...
	SEPTEMBER(Season.AUTUMN, 18, 0x666633, 1, 0x669900, 2, 0x666633), // 9
	OCTOBER(Season.AUTUMN, 10, 0xCCC000, 3, 0x991100, 1, 0x666600), // 10
	NOVEMBER(Season.AUTUMN, 2, 0xCCC000, 2, 0xCCC099, 1, 0x663300), // 11
	DECEMBER(Season.WINTER, -10, 0xCCCC99, 1, 0, 0, 0xCCCC99); // 12
