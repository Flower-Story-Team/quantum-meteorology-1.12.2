package com.konpi.quantummeteorology.api.gas;
...
public class Gas {
     ...
     *
     * @param name - name or key to associate this Gas with
     * @param color - tint of this Gas
     */
    public Gas(String name, int color) {
        this(name, "quantunmmeteorology:fluid/fluid");
        setTint(color);
    }
     ...
     */
    public Gas(Fluid color) {
        unlocalizedName = name = color.getName();
        iconLocation = color.getStill();
        fluid = color;
        from_fluid = true;
        setTint(color.getColor() & 0xFFFFFF);
    }
     ...
     *
     * @param name - unlocalized name to set
     *
     * @return this Gas object
     */
    @Deprecated
    public Gas setUnlocalizedName(String name) {
     ...
     * @return this Gas object
     */
    public Gas setTranslationKey(String name) {
